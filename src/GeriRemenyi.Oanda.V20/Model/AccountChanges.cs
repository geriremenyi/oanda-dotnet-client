...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class AccountChanges :  IEquatable<AccountChanges>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AccountChanges);
        }

        /// <summary>
        /// Returns true if AccountChanges instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountChanges to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountChanges input)
        {
            if (input == null)
                return false;
