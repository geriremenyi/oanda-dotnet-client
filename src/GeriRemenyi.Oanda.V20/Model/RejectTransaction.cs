...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class RejectTransaction :  IEquatable<RejectTransaction>, IValidatableObject
    {
        ...
        public RejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
