...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopLossOrderRejectTransaction : StopLossOrderRejectTransactionAllOf,  IEquatable<StopLossOrderRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public StopLossOrderRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int tradeID = default(int), string clientTradeID = default(string), double price = default(double), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), bool guaranteed = default(bool), double guaranteedExecutionPremium = default(double), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int)) : base()
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as StopLossOrderRejectTransaction);
        }

        /// <summary>
        /// Returns true if StopLossOrderRejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossOrderRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrderRejectTransaction input)
        {
            if (input == null)
                return false;
