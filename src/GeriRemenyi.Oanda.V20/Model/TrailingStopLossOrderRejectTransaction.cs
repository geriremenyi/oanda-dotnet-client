...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailingStopLossOrderRejectTransaction : TrailingStopLossOrderRejectTransactionAllOf,  IEquatable<TrailingStopLossOrderRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public TrailingStopLossOrderRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int tradeID = default(int), string clientTradeID = default(string), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int)) : base()
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as TrailingStopLossOrderRejectTransaction);
        }

        /// <summary>
        /// Returns true if TrailingStopLossOrderRejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailingStopLossOrderRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopLossOrderRejectTransaction input)
        {
            if (input == null)
                return false;
