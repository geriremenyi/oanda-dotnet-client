...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class OrderFillTransaction :  IEquatable<OrderFillTransaction>, IValidatableObject
    {
        ...
        public OrderFillTransaction(int orderID = default(int), string clientOrderID = default(string), InstrumentEnum? instrument = default(InstrumentEnum?), double units = default(double), double gainQuoteHomeConversionFactor = default(double), double lossQuoteHomeConversionFactor = default(double), double price = default(double), double fullVWAP = default(double), InlineResponse20021Prices fullPrice = default(InlineResponse20021Prices), ReasonEnum? reason = default(ReasonEnum?), double pl = default(double), double financing = default(double), double commission = default(double), double guaranteedExecutionFee = default(double), double accountBalance = default(double), OrderFillTransactionTradeOpened tradeOpened = default(OrderFillTransactionTradeOpened), List<OrderFillTransactionTradesClosed> tradesClosed = default(List<OrderFillTransactionTradesClosed>), OrderFillTransactionTradesClosed tradeReduced = default(OrderFillTransactionTradesClosed), double halfSpreadCost = default(double))
        {
        ...
        public InlineResponse20021Prices FullPrice { get; set; }
        ...
        public OrderFillTransactionTradeOpened TradeOpened { get; set; }
        ...
        public List<OrderFillTransactionTradesClosed> TradesClosed { get; set; }

        /// <summary>
        /// Gets or Sets TradeReduced
        /// </summary>
        [DataMember(Name="tradeReduced", EmitDefaultValue=false)]
        public OrderFillTransactionTradesClosed TradeReduced { get; set; }
