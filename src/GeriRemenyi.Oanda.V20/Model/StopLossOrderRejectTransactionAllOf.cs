...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopLossOrderRejectTransactionAllOf :  IEquatable<StopLossOrderRejectTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopLossOrderRejectTransactionAllOf" /> class.
        /// </summary>
        ...
        public StopLossOrderRejectTransactionAllOf(int tradeID = default(int), string clientTradeID = default(string), double price = default(double), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), bool guaranteed = default(bool), double guaranteedExecutionPremium = default(double), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StopLossOrderRejectTransactionAllOf {\n");
        ...
        {
            return this.Equals(input as StopLossOrderRejectTransactionAllOf);
        }

        /// <summary>
        /// Returns true if StopLossOrderRejectTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossOrderRejectTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrderRejectTransactionAllOf input)
        {
            if (input == null)
                return false;
