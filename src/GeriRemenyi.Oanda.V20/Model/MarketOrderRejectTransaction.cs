...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketOrderRejectTransaction : MarketOrderRejectTransactionAllOf,  IEquatable<MarketOrderRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public MarketOrderRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), InstrumentEnum? instrument = default(InstrumentEnum?), double units = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), double priceBound = default(double), PositionFillEnum? positionFill = default(PositionFillEnum?), MarketOrderTradeClose tradeClose = default(MarketOrderTradeClose), MarketOrderLongPositionCloseout longPositionCloseout = default(MarketOrderLongPositionCloseout), MarketOrderLongPositionCloseout shortPositionCloseout = default(MarketOrderLongPositionCloseout), MarketOrderMarginCloseout marginCloseout = default(MarketOrderMarginCloseout), MarketOrderDelayedTradeClose delayedTradeClose = default(MarketOrderDelayedTradeClose), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), AccountsAccountIDTradesTradeSpecifierOrdersTakeProfit takeProfitOnFill = default(AccountsAccountIDTradesTradeSpecifierOrdersTakeProfit), AccountsAccountIDTradesTradeSpecifierOrdersStopLoss stopLossOnFill = default(AccountsAccountIDTradesTradeSpecifierOrdersStopLoss), AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss trailingStopLossOnFill = default(AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss), InlineResponse2005ChangesClientExtensions tradeClientExtensions = default(InlineResponse2005ChangesClientExtensions)) : base()
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as MarketOrderRejectTransaction);
        }

        /// <summary>
        /// Returns true if MarketOrderRejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketOrderRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketOrderRejectTransaction input)
        {
            if (input == null)
                return false;
