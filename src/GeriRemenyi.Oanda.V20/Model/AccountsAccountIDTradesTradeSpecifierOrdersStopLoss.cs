...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountsAccountIDTradesTradeSpecifierOrdersStopLoss :  IEquatable<AccountsAccountIDTradesTradeSpecifierOrdersStopLoss>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsAccountIDTradesTradeSpecifierOrdersStopLoss" /> class.
        /// </summary>
        ...
        public AccountsAccountIDTradesTradeSpecifierOrdersStopLoss(double price = default(double), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), bool guaranteed = default(bool))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountsAccountIDTradesTradeSpecifierOrdersStopLoss {\n");
        ...
        {
            return this.Equals(input as AccountsAccountIDTradesTradeSpecifierOrdersStopLoss);
        }

        /// <summary>
        /// Returns true if AccountsAccountIDTradesTradeSpecifierOrdersStopLoss instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsAccountIDTradesTradeSpecifierOrdersStopLoss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsAccountIDTradesTradeSpecifierOrdersStopLoss input)
        {
            if (input == null)
                return false;
