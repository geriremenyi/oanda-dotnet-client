...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005ChangesOrdersCreated :  IEquatable<InlineResponse2005ChangesOrdersCreated>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005ChangesOrdersCreated" /> class.
        /// </summary>
        ...
        public InlineResponse2005ChangesOrdersCreated(int id = default(int), string createTime = default(string), StateEnum? state = default(StateEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2005ChangesOrdersCreated {\n");
        ...
        {
            return this.Equals(input as InlineResponse2005ChangesOrdersCreated);
        }

        /// <summary>
        /// Returns true if InlineResponse2005ChangesOrdersCreated instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005ChangesOrdersCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005ChangesOrdersCreated input)
        {
            if (input == null)
                return false;
