...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class ClientPrice :  IEquatable<ClientPrice>, IValidatableObject
    {
        ...
        public ClientPrice(string type = default(string), InstrumentEnum? instrument = default(InstrumentEnum?), string time = default(string), StatusEnum? status = default(StatusEnum?), bool tradeable = default(bool), List<InlineResponse20021Bids> bids = default(List<InlineResponse20021Bids>), List<InlineResponse20021Bids> asks = default(List<InlineResponse20021Bids>), double closeoutBid = default(double), double closeoutAsk = default(double), InlineResponse20021QuoteHomeConversionFactors quoteHomeConversionFactors = default(InlineResponse20021QuoteHomeConversionFactors), InlineResponse20021UnitsAvailable unitsAvailable = default(InlineResponse20021UnitsAvailable))
        {
            this.Type = type;
