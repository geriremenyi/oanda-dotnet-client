...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineObject7 :  IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        public InlineObject7(string longUnits = default(string), InlineResponse2005ChangesClientExtensions longClientExtensions = default(InlineResponse2005ChangesClientExtensions), string shortUnits = default(string), InlineResponse2005ChangesClientExtensions shortClientExtensions = default(InlineResponse2005ChangesClientExtensions))
        {
        ...
        public InlineResponse2005ChangesClientExtensions LongClientExtensions { get; set; }
        ...
        public InlineResponse2005ChangesClientExtensions ShortClientExtensions { get; set; }
