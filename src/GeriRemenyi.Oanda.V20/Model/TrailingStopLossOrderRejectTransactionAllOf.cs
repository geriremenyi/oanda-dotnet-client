...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailingStopLossOrderRejectTransactionAllOf :  IEquatable<TrailingStopLossOrderRejectTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrailingStopLossOrderRejectTransactionAllOf" /> class.
        /// </summary>
        ...
        public TrailingStopLossOrderRejectTransactionAllOf(int tradeID = default(int), string clientTradeID = default(string), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrailingStopLossOrderRejectTransactionAllOf {\n");
        ...
        {
            return this.Equals(input as TrailingStopLossOrderRejectTransactionAllOf);
        }

        /// <summary>
        /// Returns true if TrailingStopLossOrderRejectTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailingStopLossOrderRejectTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopLossOrderRejectTransactionAllOf input)
        {
            if (input == null)
                return false;
