...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007OrderBookBuckets :  IEquatable<InlineResponse2007OrderBookBuckets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007OrderBookBuckets" /> class.
        /// </summary>
        ...
        public InlineResponse2007OrderBookBuckets(double price = default(double), double longCountPercent = default(double), double shortCountPercent = default(double))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007OrderBookBuckets {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007OrderBookBuckets);
        }

        /// <summary>
        /// Returns true if InlineResponse2007OrderBookBuckets instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007OrderBookBuckets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007OrderBookBuckets input)
        {
            if (input == null)
                return false;
