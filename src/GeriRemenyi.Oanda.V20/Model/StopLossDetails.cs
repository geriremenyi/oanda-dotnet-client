...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class StopLossDetails :  IEquatable<StopLossDetails>, IValidatableObject
    {
        ...
        public StopLossDetails(double price = default(double), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), bool guaranteed = default(bool))
        {
            this.Price = price;
