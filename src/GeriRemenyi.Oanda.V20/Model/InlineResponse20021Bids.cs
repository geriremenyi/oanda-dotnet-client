...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20021Bids :  IEquatable<InlineResponse20021Bids>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20021Bids" /> class.
        /// </summary>
        ...
        public InlineResponse20021Bids(double price = default(double), int liquidity = default(int))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20021Bids {\n");
        ...
        {
            return this.Equals(input as InlineResponse20021Bids);
        }

        /// <summary>
        /// Returns true if InlineResponse20021Bids instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20021Bids to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20021Bids input)
        {
            if (input == null)
                return false;
