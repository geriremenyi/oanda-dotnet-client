...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class CalculatedPositionState :  IEquatable<CalculatedPositionState>, IValidatableObject
    {
        ...
        public CalculatedPositionState(InstrumentEnum? instrument = default(InstrumentEnum?), double netUnrealizedPL = default(double), double longUnrealizedPL = default(double), double shortUnrealizedPL = default(double), double marginUsed = default(double))
        {
