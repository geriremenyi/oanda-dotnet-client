...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class StopLossOrderTransaction :  IEquatable<StopLossOrderTransaction>, IValidatableObject
    {
        ...
        public StopLossOrderTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), int tradeID = default(int), string clientTradeID = default(string), double price = default(double), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), bool guaranteed = default(bool), double guaranteedExecutionPremium = default(double), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as StopLossOrderTransaction);
        }

        /// <summary>
        /// Returns true if StopLossOrderTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossOrderTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrderTransaction input)
        {
            if (input == null)
                return false;
