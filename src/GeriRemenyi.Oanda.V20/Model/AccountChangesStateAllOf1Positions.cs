...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountChangesStateAllOf1Positions :  IEquatable<AccountChangesStateAllOf1Positions>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountChangesStateAllOf1Positions" /> class.
        /// </summary>
        ...
        public AccountChangesStateAllOf1Positions(InstrumentEnum? instrument = default(InstrumentEnum?), double netUnrealizedPL = default(double), double longUnrealizedPL = default(double), double shortUnrealizedPL = default(double), double marginUsed = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountChangesStateAllOf1Positions {\n");
        ...
        {
            return this.Equals(input as AccountChangesStateAllOf1Positions);
        }

        /// <summary>
        /// Returns true if AccountChangesStateAllOf1Positions instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountChangesStateAllOf1Positions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountChangesStateAllOf1Positions input)
        {
            if (input == null)
                return false;
