...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderCancelRejectTransaction : OrderCancelRejectTransactionAllOf,  IEquatable<OrderCancelRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public OrderCancelRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int orderID = default(int), string clientOrderID = default(string)) : base()
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as OrderCancelRejectTransaction);
        }

        /// <summary>
        /// Returns true if OrderCancelRejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderCancelRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderCancelRejectTransaction input)
        {
            if (input == null)
                return false;
