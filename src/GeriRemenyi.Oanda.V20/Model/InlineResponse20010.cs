...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(List<InlineResponse2005ChangesOrdersCreated> orders = default(List<InlineResponse2005ChangesOrdersCreated>), int lastTransactionID = default(int))
        {
            this.Orders = orders;
