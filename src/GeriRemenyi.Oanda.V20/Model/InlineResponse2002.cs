...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="account">A summary representation of a client&#39;s Account. The AccountSummary does not provide to full specification of pending Orders, open Trades and Positions..</param>
        /// <param name="lastTransactionID">The ID of the most recent Transaction created for the Account..</param>
        public InlineResponse2002(Object account = default(Object), int lastTransactionID = default(int))
        {
        ...
        /// </summary>
        /// <value>A summary representation of a client&#39;s Account. The AccountSummary does not provide to full specification of pending Orders, open Trades and Positions.</value>
