...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(List<InlineResponse2005ChangesOrdersCreated> orders = default(List<InlineResponse2005ChangesOrdersCreated>), int lastTransactionID = default(int))
        {
            this.Orders = orders;
