...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<InlineResponse2003Instruments> instruments = default(List<InlineResponse2003Instruments>), int lastTransactionID = default(int))
        {
        ...
        public List<InlineResponse2003Instruments> Instruments { get; set; }
