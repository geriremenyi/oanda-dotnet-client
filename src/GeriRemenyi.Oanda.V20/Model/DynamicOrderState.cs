...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class DynamicOrderState :  IEquatable<DynamicOrderState>, IValidatableObject
    {
        ...
        public DynamicOrderState(int id = default(int), double trailingStopValue = default(double), double triggerDistance = default(double), bool isTriggerDistanceExact = default(bool))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as DynamicOrderState);
        }

        /// <summary>
        /// Returns true if DynamicOrderState instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicOrderState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicOrderState input)
        {
            if (input == null)
                return false;
