...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="account">The full details of a client&#39;s Account. This includes full open Trade, open Position and pending Order representation..</param>
        /// <param name="lastTransactionID">The ID of the most recent Transaction created for the Account..</param>
        public InlineResponse2001(Object account = default(Object), int lastTransactionID = default(int))
        {
        ...
        /// </summary>
        /// <value>The full details of a client&#39;s Account. This includes full open Trade, open Position and pending Order representation.</value>
