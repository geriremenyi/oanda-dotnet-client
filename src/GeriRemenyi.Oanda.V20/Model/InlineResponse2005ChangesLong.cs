...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005ChangesLong :  IEquatable<InlineResponse2005ChangesLong>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005ChangesLong" /> class.
        /// </summary>
        ...
        public InlineResponse2005ChangesLong(double units = default(double), double averagePrice = default(double), List<int> tradeIDs = default(List<int>), double pl = default(double), double unrealizedPL = default(double), double resettablePL = default(double), double financing = default(double), double guaranteedExecutionFees = default(double))
        {
            this.Units = units;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2005ChangesLong {\n");
        ...
        {
            return this.Equals(input as InlineResponse2005ChangesLong);
        }

        /// <summary>
        /// Returns true if InlineResponse2005ChangesLong instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005ChangesLong to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005ChangesLong input)
        {
            if (input == null)
                return false;
