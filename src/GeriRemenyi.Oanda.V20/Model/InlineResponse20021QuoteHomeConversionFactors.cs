...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20021QuoteHomeConversionFactors :  IEquatable<InlineResponse20021QuoteHomeConversionFactors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20021QuoteHomeConversionFactors" /> class.
        /// </summary>
        ...
        public InlineResponse20021QuoteHomeConversionFactors(double positiveUnits = default(double), double negativeUnits = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20021QuoteHomeConversionFactors {\n");
        ...
        {
            return this.Equals(input as InlineResponse20021QuoteHomeConversionFactors);
        }

        /// <summary>
        /// Returns true if InlineResponse20021QuoteHomeConversionFactors instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20021QuoteHomeConversionFactors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20021QuoteHomeConversionFactors input)
        {
            if (input == null)
                return false;
