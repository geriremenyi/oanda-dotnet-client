...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(InlineResponse2005ChangesOrdersCreated order = default(InlineResponse2005ChangesOrdersCreated), int lastTransactionID = default(int))
        {
            this.Order = order;
        ...
        public InlineResponse2005ChangesOrdersCreated Order { get; set; }
