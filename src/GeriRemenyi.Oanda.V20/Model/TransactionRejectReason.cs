...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionRejectReason :  IEquatable<TransactionRejectReason>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRejectReason" /> class.
        /// </summary>
        ...
        public TransactionRejectReason(TypeEnum? type = default(TypeEnum?), int lastTransactionID = default(int), string time = default(string))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as TransactionRejectReason);
        }

        /// <summary>
        /// Returns true if TransactionRejectReason instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRejectReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRejectReason input)
        {
            if (input == null)
                return false;
