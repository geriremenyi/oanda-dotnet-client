...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>, IValidatableObject
    {
        ...
        public InlineResponse20016(List<InlineResponse2005ChangesPositions> positions = default(List<InlineResponse2005ChangesPositions>), int lastTransactionID = default(int))
        {
