...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss :  IEquatable<AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss" /> class.
        /// </summary>
        ...
        public AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss(double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss {\n");
        ...
        {
            return this.Equals(input as AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss);
        }

        /// <summary>
        /// Returns true if AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsAccountIDTradesTradeSpecifierOrdersTrailingStopLoss input)
        {
            if (input == null)
                return false;
