...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="clientConfigureTransaction">A ClientConfigureTransaction represents the configuration of an Account by a client..</param>
        /// <param name="lastTransactionID">The ID of the last Transaction created for the Account..</param>
        public InlineResponse2004(Object clientConfigureTransaction = default(Object), int lastTransactionID = default(int))
        {
        ...
        /// </summary>
        /// <value>A ClientConfigureTransaction represents the configuration of an Account by a client.</value>
        [DataMember(Name="clientConfigureTransaction", EmitDefaultValue=false)]
        public Object ClientConfigureTransaction { get; set; }
