...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XxTransactionErrorAllOf :  IEquatable<XxTransactionErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XxTransactionErrorAllOf" /> class.
        /// </summary>
        ...
        public XxTransactionErrorAllOf(int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XxTransactionErrorAllOf {\n");
        ...
        {
            return this.Equals(input as XxTransactionErrorAllOf);
        }

        /// <summary>
        /// Returns true if XxTransactionErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of XxTransactionErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XxTransactionErrorAllOf input)
        {
            if (input == null)
                return false;
