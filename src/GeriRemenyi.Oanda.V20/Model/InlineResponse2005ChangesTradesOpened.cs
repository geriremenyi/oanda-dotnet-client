...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005ChangesTradesOpened :  IEquatable<InlineResponse2005ChangesTradesOpened>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005ChangesTradesOpened" /> class.
        /// </summary>
        ...
        public InlineResponse2005ChangesTradesOpened(int id = default(int), InstrumentEnum? instrument = default(InstrumentEnum?), double price = default(double), string openTime = default(string), StateEnum? state = default(StateEnum?), double initialUnits = default(double), double initialMarginRequired = default(double), double currentUnits = default(double), double realizedPL = default(double), double unrealizedPL = default(double), double marginUsed = default(double), double averageClosePrice = default(double), List<int> closingTransactionIDs = default(List<int>), double financing = default(double), string closeTime = default(string), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int takeProfitOrderID = default(int), int stopLossOrderID = default(int), int trailingStopLossOrderID = default(int))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2005ChangesTradesOpened {\n");
        ...
        {
            return this.Equals(input as InlineResponse2005ChangesTradesOpened);
        }

        /// <summary>
        /// Returns true if InlineResponse2005ChangesTradesOpened instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005ChangesTradesOpened to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005ChangesTradesOpened input)
        {
            if (input == null)
                return false;
