...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TakeProfitOrderTransactionBase :  IEquatable<TakeProfitOrderTransactionBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TakeProfitOrderTransactionBase" /> class.
        /// </summary>
        ...
        public TakeProfitOrderTransactionBase(int tradeID = default(int), string clientTradeID = default(string), double price = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TakeProfitOrderTransactionBase {\n");
        ...
        {
            return this.Equals(input as TakeProfitOrderTransactionBase);
        }

        /// <summary>
        /// Returns true if TakeProfitOrderTransactionBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TakeProfitOrderTransactionBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TakeProfitOrderTransactionBase input)
        {
            if (input == null)
                return false;
