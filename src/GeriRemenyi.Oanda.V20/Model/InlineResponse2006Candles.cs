...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2006Candles :  IEquatable<InlineResponse2006Candles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006Candles" /> class.
        /// </summary>
        ...
        public InlineResponse2006Candles(string time = default(string), InlineResponse2006Bid bid = default(InlineResponse2006Bid), InlineResponse2006Bid ask = default(InlineResponse2006Bid), InlineResponse2006Bid mid = default(InlineResponse2006Bid), int volume = default(int), bool complete = default(bool))
        {
            this.Time = time;
            this.Bid = bid;
            this.Ask = ask;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2006Candles {\n");
        ...
        {
            return this.Equals(input as InlineResponse2006Candles);
        }

        /// <summary>
        /// Returns true if InlineResponse2006Candles instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006Candles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006Candles input)
        {
            if (input == null)
                return false;
