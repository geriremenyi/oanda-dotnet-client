...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005ChangesPositions :  IEquatable<InlineResponse2005ChangesPositions>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005ChangesPositions" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2005ChangesPositions {\n");
        ...
        {
            return this.Equals(input as InlineResponse2005ChangesPositions);
        }

        /// <summary>
        /// Returns true if InlineResponse2005ChangesPositions instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005ChangesPositions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005ChangesPositions input)
        {
            if (input == null)
                return false;
