...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientConfigureRejectTransaction : ClientConfigureRejectTransactionAllOf,  IEquatable<ClientConfigureRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientConfigureRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), string alias = default(string), double marginRate = default(double)) : base()
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
