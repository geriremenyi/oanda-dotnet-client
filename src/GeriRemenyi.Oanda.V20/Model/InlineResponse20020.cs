...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class InlineResponse20020 :  IEquatable<InlineResponse20020>, IValidatableObject
    {
        ...
        public InlineResponse20020(List<InlineResponse2005ChangesTransactions> transactions = default(List<InlineResponse2005ChangesTransactions>), int lastTransactionID = default(int))
        {
