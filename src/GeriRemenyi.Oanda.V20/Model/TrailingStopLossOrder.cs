...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailingStopLossOrder : TrailingStopLossOrderAllOf,  IEquatable<TrailingStopLossOrder>, IValidatableObject
    {
        /// <summary>
        ...
        public TrailingStopLossOrder(int id = default(int), string createTime = default(string), StateEnum? state = default(StateEnum?), Object clientExtensions = default(Object), TypeEnum? type = default(TypeEnum?), int tradeID = default(int), string clientTradeID = default(string), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), int fillingTransactionID = default(int), string filledTime = default(string), int tradeOpenedID = default(int), int tradeReducedID = default(int), List<int> tradeClosedIDs = default(List<int>), int cancellingTransactionID = default(int), string cancelledTime = default(string), int replacesOrderID = default(int), int replacedByOrderID = default(int), double distance = default(double), double trailingStopValue = default(double)) : base()
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrailingStopLossOrder);
        }

        /// <summary>
        /// Returns true if TrailingStopLossOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailingStopLossOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopLossOrder input)
        {
            if (input == null)
                return false;
