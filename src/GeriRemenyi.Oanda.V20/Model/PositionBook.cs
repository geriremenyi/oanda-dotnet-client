...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class PositionBook :  IEquatable<PositionBook>, IValidatableObject
    {
        ...
        public PositionBook(InstrumentEnum? instrument = default(InstrumentEnum?), string time = default(string), double price = default(double), double bucketWidth = default(double), List<InlineResponse2008PositionBookBuckets> buckets = default(List<InlineResponse2008PositionBookBuckets>))
        {
