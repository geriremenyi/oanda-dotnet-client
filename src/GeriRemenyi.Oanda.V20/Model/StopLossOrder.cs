...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopLossOrder : StopLossOrderAllOf,  IEquatable<StopLossOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="clientExtensions">A ClientExtensions object allows a client to attach a clientID, tag and comment to Orders and Trades in their Account.  Do not set, modify, or delete this field if your account is associated with MT4..</param>
        ...
        public StopLossOrder(int id = default(int), string createTime = default(string), StateEnum? state = default(StateEnum?), Object clientExtensions = default(Object), TypeEnum? type = default(TypeEnum?), int tradeID = default(int), string clientTradeID = default(string), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), int fillingTransactionID = default(int), string filledTime = default(string), int tradeOpenedID = default(int), int tradeReducedID = default(int), List<int> tradeClosedIDs = default(List<int>), int cancellingTransactionID = default(int), string cancelledTime = default(string), int replacesOrderID = default(int), int replacedByOrderID = default(int), double price = default(double), double guaranteedExecutionPremium = default(double), double distance = default(double), bool guaranteed = default(bool)) : base()
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>A ClientExtensions object allows a client to attach a clientID, tag and comment to Orders and Trades in their Account.  Do not set, modify, or delete this field if your account is associated with MT4.</value>
        [DataMember(Name="clientExtensions", EmitDefaultValue=false)]
        public Object ClientExtensions { get; set; }
        ...
        {
            return this.Equals(input as StopLossOrder);
        }

        /// <summary>
        /// Returns true if StopLossOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrder input)
        {
            if (input == null)
                return false;
