...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class ClientConfigureTransaction :  IEquatable<ClientConfigureTransaction>, IValidatableObject
    {
        ...
        public ClientConfigureTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TypeEnum? type = default(TypeEnum?), string alias = default(string), double marginRate = default(double))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
