...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class TrailingStopLossDetails :  IEquatable<TrailingStopLossDetails>, IValidatableObject
    {
        ...
        public TrailingStopLossDetails(double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions))
        {
        ...
        {
            return this.Equals(input as TrailingStopLossDetails);
        }

        /// <summary>
        /// Returns true if TrailingStopLossDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailingStopLossDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopLossDetails input)
        {
            if (input == null)
                return false;
