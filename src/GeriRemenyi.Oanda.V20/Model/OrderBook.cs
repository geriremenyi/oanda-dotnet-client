...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class OrderBook :  IEquatable<OrderBook>, IValidatableObject
    {
        ...
        public OrderBook(InstrumentEnum? instrument = default(InstrumentEnum?), string time = default(string), double price = default(double), double bucketWidth = default(double), List<InlineResponse2007OrderBookBuckets> buckets = default(List<InlineResponse2007OrderBookBuckets>))
        {
