...
{
    /// <summary>
    /// Model4xxTransactionError
    /// </summary>
    [DataContract]
    public partial class Model4xxTransactionError :  IEquatable<Model4xxTransactionError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Model4xxTransactionError" /> class.
        /// </summary>
        ...
        public Model4xxTransactionError(string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Model4xxTransactionError {\n");
        ...
        {
            return this.Equals(input as Model4xxTransactionError);
        }

        /// <summary>
        /// Returns true if Model4xxTransactionError instances are equal
        /// </summary>
        /// <param name="input">Instance of Model4xxTransactionError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Model4xxTransactionError input)
        {
            if (input == null)
                return false;
