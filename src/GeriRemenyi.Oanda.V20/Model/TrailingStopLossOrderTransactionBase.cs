...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    public partial class TrailingStopLossOrderTransactionBase :  IEquatable<TrailingStopLossOrderTransactionBase>, IValidatableObject
    {
        ...
        public TrailingStopLossOrderTransactionBase(int tradeID = default(int), string clientTradeID = default(string), double distance = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
