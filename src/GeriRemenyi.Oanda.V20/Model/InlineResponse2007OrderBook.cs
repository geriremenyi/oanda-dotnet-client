...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007OrderBook :  IEquatable<InlineResponse2007OrderBook>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007OrderBook" /> class.
        /// </summary>
        ...
        public InlineResponse2007OrderBook(InstrumentEnum? instrument = default(InstrumentEnum?), string time = default(string), double price = default(double), double bucketWidth = default(double), List<InlineResponse2007OrderBookBuckets> buckets = default(List<InlineResponse2007OrderBookBuckets>))
        {
        ...
        public List<InlineResponse2007OrderBookBuckets> Buckets { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007OrderBook {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007OrderBook);
        }

        /// <summary>
        /// Returns true if InlineResponse2007OrderBook instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007OrderBook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007OrderBook input)
        {
            if (input == null)
                return false;
