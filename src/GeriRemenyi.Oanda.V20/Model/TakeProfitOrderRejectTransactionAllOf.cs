...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TakeProfitOrderRejectTransactionAllOf :  IEquatable<TakeProfitOrderRejectTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TakeProfitOrderRejectTransactionAllOf" /> class.
        /// </summary>
        ...
        public TakeProfitOrderRejectTransactionAllOf(int tradeID = default(int), string clientTradeID = default(string), double price = default(double), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), string gtdTime = default(string), TriggerConditionEnum? triggerCondition = default(TriggerConditionEnum?), ReasonEnum? reason = default(ReasonEnum?), InlineResponse2005ChangesClientExtensions clientExtensions = default(InlineResponse2005ChangesClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TakeProfitOrderRejectTransactionAllOf {\n");
        ...
        {
            return this.Equals(input as TakeProfitOrderRejectTransactionAllOf);
        }

        /// <summary>
        /// Returns true if TakeProfitOrderRejectTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TakeProfitOrderRejectTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TakeProfitOrderRejectTransactionAllOf input)
        {
            if (input == null)
                return false;
