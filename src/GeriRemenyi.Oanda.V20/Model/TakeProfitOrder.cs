...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TakeProfitOrder : TakeProfitOrderAllOf,  IEquatable<TakeProfitOrder>, IValidatableObject
    {
        /// <summary>
