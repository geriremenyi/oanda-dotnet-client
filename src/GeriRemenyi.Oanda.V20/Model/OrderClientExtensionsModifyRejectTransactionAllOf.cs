...
namespace GeriRemenyi.Oanda.V20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderClientExtensionsModifyRejectTransactionAllOf :  IEquatable<OrderClientExtensionsModifyRejectTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderClientExtensionsModifyRejectTransactionAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderClientExtensionsModifyRejectTransactionAllOf {\n");
        ...
        {
            return this.Equals(input as OrderClientExtensionsModifyRejectTransactionAllOf);
        }

        /// <summary>
        /// Returns true if OrderClientExtensionsModifyRejectTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderClientExtensionsModifyRejectTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderClientExtensionsModifyRejectTransactionAllOf input)
        {
            if (input == null)
                return false;
