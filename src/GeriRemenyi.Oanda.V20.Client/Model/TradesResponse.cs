...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradesResponse :  IEquatable<TradesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradesResponse" /> class.
        /// </summary>
        ...
        public TradesResponse(List<Trade> trades = default(List<Trade>), int lastTransactionID = default(int))
        {
            this.Trades = trades;
        ...
        {
            return this.Equals(input as TradesResponse);
        }

        /// <summary>
        /// Returns true if TradesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TradesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradesResponse input)
        {
            if (input == null)
                return false;
