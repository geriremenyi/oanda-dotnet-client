...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloseTradeNotFoundResponse :  IEquatable<CloseTradeNotFoundResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseTradeNotFoundResponse {\n");
        ...
        {
            return this.Equals(input as CloseTradeNotFoundResponse);
        }

        /// <summary>
        /// Returns true if CloseTradeNotFoundResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseTradeNotFoundResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseTradeNotFoundResponse input)
        {
            if (input == null)
                return false;
