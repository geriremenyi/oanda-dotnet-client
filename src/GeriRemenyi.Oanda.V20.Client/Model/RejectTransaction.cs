...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RejectTransaction :  IEquatable<RejectTransaction>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RejectTransaction" /> class.
        /// </summary>
        ...
        public RejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RejectTransaction {\n");
        ...
        {
            return this.Equals(input as RejectTransaction);
        }

        /// <summary>
        /// Returns true if RejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of RejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RejectTransaction input)
        {
            if (input == null)
                return false;
