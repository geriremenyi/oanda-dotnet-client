...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class AccountChangesState :  IEquatable<AccountChangesState>, IValidatableObject
    {
        ...
        public AccountChangesState(double unrealizedPL = default(double), double nAV = default(double), double marginUsed = default(double), double marginAvailable = default(double), double positionValue = default(double), double marginCloseoutUnrealizedPL = default(double), double marginCloseoutNAV = default(double), double marginCloseoutMarginUsed = default(double), double marginCloseoutPercent = default(double), double marginCloseoutPositionValue = default(double), double withdrawalLimit = default(double), double marginCallMarginUsed = default(double), double marginCallPercent = default(double), List<DynamicOrderState> orders = default(List<DynamicOrderState>), List<CalculatedTradeState> trades = default(List<CalculatedTradeState>), List<CalculatedPositionState> positions = default(List<CalculatedPositionState>))
        {
