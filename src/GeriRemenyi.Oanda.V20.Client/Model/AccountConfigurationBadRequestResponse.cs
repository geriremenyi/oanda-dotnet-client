...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountConfigurationBadRequestResponse :  IEquatable<AccountConfigurationBadRequestResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConfigurationBadRequestResponse" /> class.
        /// </summary>
        ...
        public AccountConfigurationBadRequestResponse(ClientConfigureRejectTransaction clientConfigureRejectTransaction = default(ClientConfigureRejectTransaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConfigurationBadRequestResponse {\n");
        ...
        {
            return this.Equals(input as AccountConfigurationBadRequestResponse);
        }

        /// <summary>
        /// Returns true if AccountConfigurationBadRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConfigurationBadRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConfigurationBadRequestResponse input)
        {
            if (input == null)
                return false;
