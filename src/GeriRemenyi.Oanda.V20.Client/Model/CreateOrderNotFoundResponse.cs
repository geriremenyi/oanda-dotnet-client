...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateOrderNotFoundResponse :  IEquatable<CreateOrderNotFoundResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderNotFoundResponse" /> class.
        /// </summary>
        ...
        public CreateOrderNotFoundResponse(Transaction orderRejectTransaction = default(Transaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrderNotFoundResponse {\n");
        ...
        {
            return this.Equals(input as CreateOrderNotFoundResponse);
        }

        /// <summary>
        /// Returns true if CreateOrderNotFoundResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrderNotFoundResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrderNotFoundResponse input)
        {
            if (input == null)
                return false;
