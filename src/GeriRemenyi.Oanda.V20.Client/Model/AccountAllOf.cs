...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class AccountAllOf :  IEquatable<AccountAllOf>, IValidatableObject
    {
        ...
        public AccountAllOf(List<TradeSummary> trades = default(List<TradeSummary>), List<Position> positions = default(List<Position>), List<Order> orders = default(List<Order>))
        {
            this.Trades = trades;
