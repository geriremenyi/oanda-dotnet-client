...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Error401 : Error4xxBody,  IEquatable<Error401>, IValidatableObject
    {
        /// <summary>
        ...
        public Error401(string errorCode = default(string), string errorMessage = default(string)) : base(errorCode, errorMessage)
        {
        }
