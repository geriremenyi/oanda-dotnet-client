...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Error4xxTransaction :  IEquatable<Error4xxTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Error4xxTransaction" /> class.
        /// </summary>
        ...
        public Error4xxTransaction(string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Error4xxTransaction {\n");
        ...
        {
            return this.Equals(input as Error4xxTransaction);
        }

        /// <summary>
        /// Returns true if Error4xxTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of Error4xxTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Error4xxTransaction input)
        {
            if (input == null)
                return false;
