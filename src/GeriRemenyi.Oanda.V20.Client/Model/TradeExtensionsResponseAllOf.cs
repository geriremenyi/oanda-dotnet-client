...
{
    /// <summary>
    /// TradeExtensionsResponseAllOf
    /// </summary>
    [DataContract]
    public partial class TradeExtensionsResponseAllOf :  IEquatable<TradeExtensionsResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeExtensionsResponseAllOf {\n");
        ...
        {
            return this.Equals(input as TradeExtensionsResponseAllOf);
        }

        /// <summary>
        /// Returns true if TradeExtensionsResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeExtensionsResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeExtensionsResponseAllOf input)
        {
            if (input == null)
                return false;
