...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateOrderBadRequestResponse :  IEquatable<CreateOrderBadRequestResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderBadRequestResponse" /> class.
        /// </summary>
        ...
        public CreateOrderBadRequestResponse(Transaction orderRejectTransaction = default(Transaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrderBadRequestResponse {\n");
        ...
        {
            return this.Equals(input as CreateOrderBadRequestResponse);
        }

        /// <summary>
        /// Returns true if CreateOrderBadRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrderBadRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrderBadRequestResponse input)
        {
            if (input == null)
                return false;
