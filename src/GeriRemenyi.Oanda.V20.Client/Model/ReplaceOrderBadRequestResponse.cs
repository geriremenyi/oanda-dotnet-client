...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceOrderBadRequestResponse :  IEquatable<ReplaceOrderBadRequestResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceOrderBadRequestResponse" /> class.
        /// </summary>
        ...
        public ReplaceOrderBadRequestResponse(Transaction orderClientExtensionsModifyRejectTransaction = default(Transaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplaceOrderBadRequestResponse {\n");
        ...
        {
            return this.Equals(input as ReplaceOrderBadRequestResponse);
        }

        /// <summary>
        /// Returns true if ReplaceOrderBadRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceOrderBadRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceOrderBadRequestResponse input)
        {
            if (input == null)
                return false;
