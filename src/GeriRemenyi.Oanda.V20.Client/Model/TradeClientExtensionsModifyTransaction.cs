...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class TradeClientExtensionsModifyTransaction :  IEquatable<TradeClientExtensionsModifyTransaction>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TradeClientExtensionsModifyTransaction);
        }

        /// <summary>
        /// Returns true if TradeClientExtensionsModifyTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeClientExtensionsModifyTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeClientExtensionsModifyTransaction input)
        {
            if (input == null)
                return false;
