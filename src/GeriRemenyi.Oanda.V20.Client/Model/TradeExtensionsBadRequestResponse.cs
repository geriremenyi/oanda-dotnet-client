...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradeExtensionsBadRequestResponse :  IEquatable<TradeExtensionsBadRequestResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeExtensionsBadRequestResponse {\n");
        ...
        {
            return this.Equals(input as TradeExtensionsBadRequestResponse);
        }

        /// <summary>
        /// Returns true if TradeExtensionsBadRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeExtensionsBadRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeExtensionsBadRequestResponse input)
        {
            if (input == null)
                return false;
