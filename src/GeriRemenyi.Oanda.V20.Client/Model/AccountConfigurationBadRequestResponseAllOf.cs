...
{
    /// <summary>
    /// AccountConfigurationBadRequestResponseAllOf
    /// </summary>
    [DataContract]
    public partial class AccountConfigurationBadRequestResponseAllOf :  IEquatable<AccountConfigurationBadRequestResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConfigurationBadRequestResponseAllOf {\n");
        ...
        {
            return this.Equals(input as AccountConfigurationBadRequestResponseAllOf);
        }

        /// <summary>
        /// Returns true if AccountConfigurationBadRequestResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConfigurationBadRequestResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConfigurationBadRequestResponseAllOf input)
        {
            if (input == null)
                return false;
