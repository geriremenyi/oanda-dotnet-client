...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpenTradeResponse :  IEquatable<OpenTradeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenTradeResponse" /> class.
        /// </summary>
        ...
        public OpenTradeResponse(List<Trade> trades = default(List<Trade>), int lastTransactionID = default(int))
        {
            this.Trades = trades;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenTradeResponse {\n");
        ...
        {
            return this.Equals(input as OpenTradeResponse);
        }

        /// <summary>
        /// Returns true if OpenTradeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenTradeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenTradeResponse input)
        {
            if (input == null)
                return false;
