...
{
    /// <summary>
    /// ClosePositionResponseAllOf
    /// </summary>
    [DataContract]
    public partial class ClosePositionResponseAllOf :  IEquatable<ClosePositionResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClosePositionResponseAllOf {\n");
        ...
        {
            return this.Equals(input as ClosePositionResponseAllOf);
        }

        /// <summary>
        /// Returns true if ClosePositionResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ClosePositionResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClosePositionResponseAllOf input)
        {
            if (input == null)
                return false;
