...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Error4xxBody :  IEquatable<Error4xxBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Error4xxBody" /> class.
        /// </summary>
        ...
        public Error4xxBody(string errorCode = default(string), string errorMessage = default(string))
        {
        ...
        {
            return this.Equals(input as Error4xxBody);
        }

        /// <summary>
        /// Returns true if Error4xxBody instances are equal
        /// </summary>
        /// <param name="input">Instance of Error4xxBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Error4xxBody input)
        {
            if (input == null)
                return false;
