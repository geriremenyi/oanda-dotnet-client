...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClosePositionNotFoundResponse :  IEquatable<ClosePositionNotFoundResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClosePositionNotFoundResponse {\n");
        ...
        {
            return this.Equals(input as ClosePositionNotFoundResponse);
        }

        /// <summary>
        /// Returns true if ClosePositionNotFoundResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClosePositionNotFoundResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClosePositionNotFoundResponse input)
        {
            if (input == null)
                return false;
