...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradeExtensionsNotFoundResponse :  IEquatable<TradeExtensionsNotFoundResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeExtensionsNotFoundResponse {\n");
        ...
        {
            return this.Equals(input as TradeExtensionsNotFoundResponse);
        }

        /// <summary>
        /// Returns true if TradeExtensionsNotFoundResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeExtensionsNotFoundResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeExtensionsNotFoundResponse input)
        {
            if (input == null)
                return false;
