...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class TradeClientExtensionsModifyRejectTransaction :  IEquatable<TradeClientExtensionsModifyRejectTransaction>, IValidatableObject
    {
        ...
        public TradeClientExtensionsModifyRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int tradeID = default(int), string clientTradeID = default(string), ClientExtensions tradeClientExtensionsModify = default(ClientExtensions))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
        ...
        {
            return this.Equals(input as TradeClientExtensionsModifyRejectTransaction);
        }

        /// <summary>
        /// Returns true if TradeClientExtensionsModifyRejectTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeClientExtensionsModifyRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeClientExtensionsModifyRejectTransaction input)
        {
            if (input == null)
                return false;
