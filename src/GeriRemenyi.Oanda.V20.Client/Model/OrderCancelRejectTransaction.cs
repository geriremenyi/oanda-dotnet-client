...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class OrderCancelRejectTransaction :  IEquatable<OrderCancelRejectTransaction>, IValidatableObject
    {
        ...
        public OrderCancelRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int orderID = default(int), string clientOrderID = default(string))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
