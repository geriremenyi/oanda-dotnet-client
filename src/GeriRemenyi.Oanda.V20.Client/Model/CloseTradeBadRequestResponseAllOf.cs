...
{
    /// <summary>
    /// CloseTradeBadRequestResponseAllOf
    /// </summary>
    [DataContract]
    public partial class CloseTradeBadRequestResponseAllOf :  IEquatable<CloseTradeBadRequestResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseTradeBadRequestResponseAllOf {\n");
        ...
        {
            return this.Equals(input as CloseTradeBadRequestResponseAllOf);
        }

        /// <summary>
        /// Returns true if CloseTradeBadRequestResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseTradeBadRequestResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseTradeBadRequestResponseAllOf input)
        {
            if (input == null)
                return false;
