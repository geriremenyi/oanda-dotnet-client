...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class StopLossOrderRejectTransaction :  IEquatable<StopLossOrderRejectTransaction>, IValidatableObject
    {
        ...
        public StopLossOrderRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int tradeID = default(int), string clientTradeID = default(string), double price = default(double), double distance = default(double), TradeOrderTimeInForce? timeInForce = default(TradeOrderTimeInForce?), string gtdTime = default(string), TradeOrderTriggerCondition? triggerCondition = default(TradeOrderTriggerCondition?), bool guaranteed = default(bool), double guaranteedExecutionPremium = default(double), TradeOrderTransactionReason? reason = default(TradeOrderTransactionReason?), ClientExtensions clientExtensions = default(ClientExtensions), int orderFillTransactionID = default(int), int replacesOrderID = default(int), int cancellingTransactionID = default(int))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
