...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceOrderNotFoundResponse :  IEquatable<ReplaceOrderNotFoundResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceOrderNotFoundResponse" /> class.
        /// </summary>
        ...
        public ReplaceOrderNotFoundResponse(Transaction orderClientExtensionsModifyRejectTransaction = default(Transaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplaceOrderNotFoundResponse {\n");
        ...
        {
            return this.Equals(input as ReplaceOrderNotFoundResponse);
        }

        /// <summary>
        /// Returns true if ReplaceOrderNotFoundResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceOrderNotFoundResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceOrderNotFoundResponse input)
        {
            if (input == null)
                return false;
