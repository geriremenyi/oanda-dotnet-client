...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradeExtensionsRequest :  IEquatable<TradeExtensionsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeExtensionsRequest {\n");
        ...
        {
            return this.Equals(input as TradeExtensionsRequest);
        }

        /// <summary>
        /// Returns true if TradeExtensionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeExtensionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeExtensionsRequest input)
        {
            if (input == null)
                return false;
