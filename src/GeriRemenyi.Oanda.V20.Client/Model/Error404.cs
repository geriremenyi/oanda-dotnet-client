...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Error404 : Error4xxBody,  IEquatable<Error404>, IValidatableObject
    {
        /// <summary>
        ...
        public Error404(string errorCode = default(string), string errorMessage = default(string)) : base(errorCode, errorMessage)
        {
        }
