...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class OrderClientExtensionsModifyRejectTransaction :  IEquatable<OrderClientExtensionsModifyRejectTransaction>, IValidatableObject
    {
        ...
        public OrderClientExtensionsModifyRejectTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), RejectReasonEnum? rejectReason = default(RejectReasonEnum?), int orderID = default(int), string clientOrderID = default(string), ClientExtensions clientExtensionsModify = default(ClientExtensions), ClientExtensions tradeClientExtensionsModify = default(ClientExtensions))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
