...
{
    /// <summary>
    /// OrderExtensionsBadRequestResponseAllOf
    /// </summary>
    [DataContract]
    public partial class OrderExtensionsBadRequestResponseAllOf :  IEquatable<OrderExtensionsBadRequestResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderExtensionsBadRequestResponseAllOf {\n");
        ...
        {
            return this.Equals(input as OrderExtensionsBadRequestResponseAllOf);
        }

        /// <summary>
        /// Returns true if OrderExtensionsBadRequestResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderExtensionsBadRequestResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderExtensionsBadRequestResponseAllOf input)
        {
            if (input == null)
                return false;
