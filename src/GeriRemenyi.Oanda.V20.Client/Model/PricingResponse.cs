...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PricingResponse :  IEquatable<PricingResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingResponse" /> class.
        /// </summary>
        ...
        public PricingResponse(List<ClientPrice> prices = default(List<ClientPrice>), List<HomeConversions> homeConversions = default(List<HomeConversions>), string time = default(string))
        {
            this.Prices = prices;
        ...
        {
            return this.Equals(input as PricingResponse);
        }

        /// <summary>
        /// Returns true if PricingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingResponse input)
        {
            if (input == null)
                return false;
