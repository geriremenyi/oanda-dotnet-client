...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloseTradeBadRequestResponse :  IEquatable<CloseTradeBadRequestResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseTradeBadRequestResponse" /> class.
        /// </summary>
        ...
        public CloseTradeBadRequestResponse(MarketOrderRejectTransaction orderRejectTransaction = default(MarketOrderRejectTransaction), string errorCode = default(string), string errorMessage = default(string), int lastTransactionID = default(int), List<int> relatedTransactionIDs = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseTradeBadRequestResponse {\n");
        ...
        {
            return this.Equals(input as CloseTradeBadRequestResponse);
        }

        /// <summary>
        /// Returns true if CloseTradeBadRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseTradeBadRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseTradeBadRequestResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.OrderRejectTransaction == input.OrderRejectTransaction ||
                    (this.OrderRejectTransaction != null &&
                    this.OrderRejectTransaction.Equals(input.OrderRejectTransaction))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OrderRejectTransaction != null)
                    hashCode = hashCode * 59 + this.OrderRejectTransaction.GetHashCode();
