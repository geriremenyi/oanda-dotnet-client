...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    public partial class OrderCancelTransaction :  IEquatable<OrderCancelTransaction>, IValidatableObject
    {
        ...
        public OrderCancelTransaction(int id = default(int), string time = default(string), int userID = default(int), string accountID = default(string), int batchID = default(int), string requestID = default(string), TransactionType? type = default(TransactionType?), int orderID = default(int), string clientOrderID = default(string), OrderCancelReason? reason = default(OrderCancelReason?), int replacedByOrderID = default(int))
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
