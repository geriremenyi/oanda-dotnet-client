...
namespace GeriRemenyi.Oanda.V20.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Error403 : Error4xxBody,  IEquatable<Error403>, IValidatableObject
    {
        /// <summary>
        ...
        public Error403(string errorCode = default(string), string errorMessage = default(string)) : base(errorCode, errorMessage)
        {
        }
